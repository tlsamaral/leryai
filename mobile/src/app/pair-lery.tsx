...
const styles = StyleSheet.create({
  ...
  heroTexts: { gap: 4 },
  heroTitle: { color: '#F6FAFE', fontFamily: theme.fonts.black, fontSize: 24, letterSpacing: -0.5 },
  heroSub: { color: 'rgba(229,250,255,0.55)', fontFamily: theme.fonts.bold, fontSize: 13, lineHeight: 18, opacity: 0.8 },
  ...
  cardTitle: { color: theme.colors.text, fontFamily: theme.fonts.black, fontSize: 15, letterSpacing: -0.2 },
  cardSub: { color: theme.colors.muted, fontFamily: theme.fonts.bold, fontSize: 12, opacity: 0.85 },
  ...
  successText: { color: theme.colors.mint, fontFamily: theme.fonts.bold, fontSize: 13 },
  errorRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  errorText: { color: theme.colors.danger, fontFamily: theme.fonts.bold, fontSize: 13 },
  hint: { color: theme.colors.dim, fontFamily: theme.fonts.bold, fontSize: 11, opacity: 0.8 },
  ...
  emptyText: { color: theme.colors.muted, fontFamily: theme.fonts.bold, fontSize: 13, opacity: 0.8 },
  deviceList: { gap: 8 },
  deviceItem: {
  ...
  deviceName: { color: theme.colors.text, fontFamily: theme.fonts.black, fontSize: 14 },
  deviceNameSelected: { color: theme.colors.primaryDeep },
  deviceSerial: { color: theme.colors.muted, fontFamily: theme.fonts.bold, fontSize: 11, opacity: 0.8 },
  deviceRadio: {
